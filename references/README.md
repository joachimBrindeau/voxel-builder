...
| "Find, audit, or populate sameAs identity links for any Voxel CPT" | [`../workflows/identity-linking.md`](../workflows/identity-linking.md) + [`sameas-identity-links.md`](voxel/sameas-identity-links.md) |
...
| **Database cleanup** | [`../workflows/database-cleanup.md`](../workflows/database-cleanup.md) + [`references/voxel/database-cleanup.md`](voxel/database-cleanup.md) | Ownership-first WordPress cleanup: backup/restore gate, parallel audit, API-first retention, proven structural orphans, Voxel/Elementor/plugin data, autoload/cron/session policy, regeneration, maintenance, rollback, and behavior verification |
...
| **sameAs identity links** | [`../workflows/identity-linking.md`](../workflows/identity-linking.md) + [`references/voxel/sameas-identity-links.md`](voxel/sameas-identity-links.md) | CPT-agnostic identity research, exact-equivalence gates, canonical URL normalization, reversible Voxel population, and schema handoff |
